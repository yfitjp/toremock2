...
{{
  ...
  "image_generation_prompt": "この記事のテーマと内容（タイトル: {article_title}）を良く表し、さらに見た人の興味を引くような、サムネイル画像を生成するための、具体的な英語のプロンプト（100単語くらい）を記述してください。必ず'realistic photo'を生成するように指示してください。**画像内に文字列は一切含まれないようにください。**登場人物がいる場合は日本人(Japanese)であることを明記してください。"
}}
```
