...
function PurchasesPage() {
    ...
    if (purchases.length === 0) {
        ...
        <div className="bg-white shadow-md rounded-lg p-6 text-center">
          ...
          <link_1.default href="/exams" className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700">
            模試を探す
          </link_1.default>
        </div>
      </div>);
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {purchases.map((purchase) => (<tr key={purchase.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${purchase.status === 'active'
                ...
                : 'bg-red-100 text-red-800'}`}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    {purchase.status === 'active' && (<link_1.default href={`/exams/${purchase.examId}/take`} className="text-blue-600 hover:text-blue-900">
                        受験する
                      </link_1.default>)}
                  </td>
                </tr>))}
