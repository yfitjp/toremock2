...
async function POST(request) {
    ...
    try {
            ...
            case 'checkout.session.completed': {
                ...
                try {
                    ...
                    if (targetUserId && (type === 'subscription' || mode === 'subscription')) {
                        ...
                        try {
                            const result = await (0, subscription_update_1.updateSubscriptionStatus)(targetUserId, 'active');
        ...
        return server_1.NextResponse.json({ error: 'Webhook処理中にエラーが発生しました（記録済み）' }, { status: 200 });
    }
}
