          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            {loading || checkingSubscription ? (
              ...
              <div className="flex items-center space-x-4">
                ...
                <Link
                  href="/mypage"
                  className="bg-blue-100 text-blue-800 hover:from-blue-200 hover:to-blue-300 px-4 py-2 rounded-md text-sm font-medium transition-all duration-200 transform hover:scale-105"
                >
                  マイページ
                </Link>
              </div>
