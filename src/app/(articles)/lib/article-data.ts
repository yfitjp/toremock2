...
export const articleData: Record<string, ArticleData> = {
  'toeic-mocktest-comparison': { // Date: 2025-04-01
  ...
  'toefl-speaking-services': { // Date: 2025-04-05
  ...
  'toeic-beginners-guide': { // Date: 2025-04-10
  ...
  'eiken-toeic-comparison': { // Date: 2025-04-15
   ...
   'toefl-writing-guide': { // Date: 2025-04-20
  ...
  'reading-skills-guide': { // Date: 2025-04-25
  ...
  'toeic-part5-strategy': { // Date: 2025-04-28
  ...
  'effective-vocabulary-learning': { // Date: 2025-04-30
